...
const steps = [
  {
    ...
    description: 'Crea tu cuenta en nuestra plataforma y completa tu perfil con tus datos personales. Todo el proceso es 100% en línea y seguro.',
    details: [
  ...
  },
  {
    ...
    title: 'Firma del Poder Notarial',
    description: 'Firmamos juntos un Poder Notarial Duradero (POA) certificado bajo las leyes de Florida. Este documento legal te otorga control total.',
    details: [
      'POA duradero bajo ley de Florida',
      'Proceso notarial certificado',
  ...
  },
  {
    ...
    description: 'Defines y registras tus instrucciones financieras de forma segura. Solo tú puedes modificarlas y solo actuaremos cuando lo autorices.',
    details: [
      'Instrucciones encriptadas y seguras',
  ...
  },
  {
    ...
    description: 'Cuando lo necesites, autorizas operaciones específicas. Verificamos tu identidad y ejecutamos tus instrucciones con precisión.',
    details: [
      'Autorización verificada en tiempo real',
      'Ejecución precisa de instrucciones',
  ...
  },
  {
    ...
    description: 'Recibe reportes detallados de todas las operaciones realizadas. Total transparencia con documentación completa.',
    details: [
